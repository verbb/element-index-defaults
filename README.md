<p align="center"><img src="https://assets.verbb.io/plugins/element-index-defaults/element-index-defaults-icon.svg" width="100" height="100" alt="Element Index Defaults icon"></p>
...
Defaults can be configured per element type and source, including registered third-party element types.
